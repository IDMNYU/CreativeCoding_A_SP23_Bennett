# Syllabus for DM-UY-1133-A Creative Coding Spring 2023
...
• If you come down with COVID, please send me a copy or image of a test result to get a zoom link.
...
## Attendance
Attendance is mandatory and will be noted for the entire duration of the class period. If you need to leave (for what ever reason), you are responsible for the material missed. Since there is so much technical, conceptual, and design information to absorb, regular attendance is essential. Unexcused absences (without a note from a doctor or agency or Ms. Rayment (Coordinator of Student Advocacy) deanna.rayment@nyu.edu, 646.997.3046) will affect your grade. 


• four unexcused absences are allowed; After that, your final overall grade for the course will drop by 2.5 points out of 100 for each additional unexcused absences.
...
• Contact me in advance if you will not be in class. ([Slack](https://creativecodin-bea1516.slack.com) DIRECT MESSAGE is preferred). Demonstrate time management, communication and respect.
